...
// Note: JsonDeserializer/JsonSerializer are deprecated in Spring Kafka 3.x but still functional
// ErrorHandlingDeserializer provides proper error handling for deprecated JsonDeserializer
